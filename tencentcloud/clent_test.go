...
import (
	...
	tencentcloud2 "github.com/vincenthcui/awesome-tencentcloud-go/tencentcloud"
...
func TestClient_Send(t *testing.T) {
	cli := tencentcloud2.NewClient(tencentcloud2.ClientOpts{SecretID: secretID, SecretKey: secretKey})
